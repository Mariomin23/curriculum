        ...
        render: () => {
            ...
            return `
                <div class="fade-in text-center py-5">
                    ...
                    <img src="cv.jpg" alt="CV Mario Minuesa" class="d-block mx-auto mb-4 cv-pdf-placeholder" style="max-width: 200px; height: 260px; object-fit: cover;">
                    <a href="cv.pdf" class="btn btn-primary btn-lg shadow px-5" download>
